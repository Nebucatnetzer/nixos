...
Two directories stay writable. `~/.claude/plans/` is yours: keep writing and updating your plan
file as the "Plans and task lists" rules require. `.git` is writable too, so you can still
stage and commit changes that I have already applied.
