...
images=("docker.io/linuxserver/grav" "lscr.io/linuxserver/plex" "lscr.io/linuxserver/heimdall" "docker.io/fireflyiii/data-importer" "docker.io/mailserver/docker-mailserver" "docker.io/gitea/gitea" "ghcr.io/nebucatnetzer/nextcloud-smb/nextcloud-smb")
