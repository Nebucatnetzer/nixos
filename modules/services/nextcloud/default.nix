...
let
  ...
  nextcloudImage = "ghcr.io/nebucatnetzer/nextcloud-smb/nextcloud-smb:31.0.7@sha256:dbf2a25e4f1b1193558ebb1730f80794894ff4bd04cecb496782736b1a117eb4";
...
in
{
  ...
  config = lib.mkIf cfg.enable {
    ...
    virtualisation.oci-containers = {
      ...
      containers."nginx" = {
        image = "docker.io/nginx:1.29.0@sha256:93230cd54060f497430c7a120e2347894846a81b6a5dd2110f7362c5423b4abc";
        autoStart = true;
        ports = [ "8080:80" ];
        volumes = [
