...
let
  ...
  nextcloudImage = "ghcr.io/nebucatnetzer/nextcloud-smb/nextcloud-smb:31.0.8@sha256:f54fa723c393b8f760a177a4e1b70cdf06a5b1027189f1c1f2ac8e8254815c92";
...
in
{
  ...
  config = lib.mkIf cfg.enable {
    ...
    virtualisation.oci-containers = {
      ...
      containers."nginx" = {
        image = "docker.io/nginx:1.29.1@sha256:33e0bbc7ca9ecf108140af6288c7c9d1ecc77548cbfd3952fd8466a75edefe57";
        autoStart = true;
        ports = [ "8080:80" ];
        volumes = [
